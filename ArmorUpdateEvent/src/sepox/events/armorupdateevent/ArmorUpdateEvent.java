...
public final class ArmorUpdateEvent extends PlayerEvent implements Cancellable{
	 ...
	 */
	public ArmorUpdateEvent(final Player player, final EquipMethod equipType, final ArmorType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
		super(player);
	...
	public enum EquipMethod{// These have got to be the worst documentations ever.
		...
		DEATH,
		/**
		 * When another plugin edit the inventory
		 */
		PLUGIN
		;
	}
